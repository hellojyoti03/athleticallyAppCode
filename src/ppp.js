// import { Dimensions, TextInput, Text, TouchableOpacity, View, Alert, StatusBar, Image, ScrollView, StyleSheet, ActivityIndicator } from 'react-native'
...
//             formData.append('type', sportsassociate && sportsassociate);  // send Personality Type id here
//             formData.append('org_desc', designation && designation); // send org Description here
//             formData.append('certifications', certifications && JSON.stringify(certifications));
//             formData.append('team_size', teamsize && teamsize);
//             formData.append('org_type', selectorganizationtype && selectorganizationtype); // send organizationtype id here
//             formData.append('home_ground', homeground && homeground);
//             formData.append('game_id', selectedgameid && selectedgameid); // send game id for player and sportsassociate_with for other Personalities and teams
...
//             formData.append('current_clubs', clubs && JSON.stringify(clubs));
//             formData.append('awards', awards && JSON.stringify(awards));
...
//             formData.append('coaches', coaches && JSON.stringify(coaches));  //done player
//             formData.append('key_parsonalities', keyPersonalities && JSON.stringify(keyPersonalities));
...
//             // formData.append('players', playersnames && JSON.stringify(playersnames));
//             if (photo && photo) {
...
//             navigation.navigate("ProfileUpdatePage")
//         } catch (error) {
...
//     console.log("medalsmedals", medals && medals)
//     ///////////////////// playersnames ///////////////////
//     const [playersnames, setplayersnames] = useState([{ id: 1, name: '' }]);
//     const addplayersnames = () => {
//         const newplayersnames = [...playersnames, { name: '' }];
...
//         updatedplayersnames[index].name = text;
...
//         updatedkeyPersonalities[index][field] = text;
//         setKeyPersonalities(updatedkeyPersonalities);
//     };
...
//                                 placeholderTextColor={'#000'}
//                                 onChangeText={value => setsportsassociate(value)}
//                                 style={{
//                                     width: '100%',
//                                     borderBottomWidth: 0.29,
//                                     borderBottomColor: "#fff",
...
//                                 <View key={activelyparticipates.id} style={{ flexDirection: 'row', alignItems: 'center' }}>
...
//                         <TouchableOpacity
//                             onPress={() => sendupdatedata()}
//                             style={{ marginTop: 5, width: "100%", backgroundColor: "#000", marginBottom: 10, borderRadius: 10,marginTop:5}}>
//                             {
//                                 load && load ?
//                                     <ActivityIndicator
//                                         style={{ paddingVertical: 10 }}
