...
const ProfileForm = ({route}) => {
  ...
  const sendupdatedata = async () => {
    ...
    try {
      ...
      const nonEmptyctivelyparticipate = activelyparticipate.filter(
        activelyp => activelyp.name.trim() !== '',
      );
      const nonEmptyteamplayers = teamplayers.filter(
        teamplayer => teamplayer.name.trim() !== '',
      );
      const nonEmptyalumniplayers = alumniplayers.filter(
        alumniplayer => alumniplayer.name.trim() !== '',
      );
      const nonEmptyAwards = awards.filter(award => award.name.trim() !== '');
      const nonEmptymedals = medals.filter(medal => medal.name.trim() !== '');
      const nonEmptyotherstaff = otherstaff.filter(
        otherstaf => otherstaf.name.trim() !== '',
      );
      const nonEmptyteamcoaches = teamcoaches.filter(
        teamcoache => teamcoache.name.trim() !== '',
      );
      const nonEmptycertifications = certifications.filter(
        certification => certification.name.trim() !== '',
      );
      const nonEmptychampionships = championships.filter(
        championship => championship.championship.trim() !== '',
      );
      const nonEmptymanagements = managements.filter(
        management => management.name.trim() !== '',
      );
      const isEmptykeyPersonalities =
        keyPersonalities.length === 0 ||
        keyPersonalities.every(
          keyPersonalities =>
            keyPersonalities.name === '' && keyPersonalities.designation === '',
        );
      const isEmptyClubs =
        clubs.length === 0 ||
        clubs.every(
          club => club.name === '' && club.from === '' && club.to === '',
        );
      const isEmptycoaches =
        coaches.length === 0 ||
        coaches.every(
          club => club.name === '' && club.from === '' && club.to === '',
        );
      ...
      if (nonEmptychampionships.length === 0) {
        ...
        formData.append(
          'competition_won',
          championships && JSON.stringify(championships),
        );
      }
      ...
      if (nonEmptymanagements.length === 0) {
        ...
        formData.append(
          'managements',
          managements && JSON.stringify(managements),
        );
      }
      ...
      if (nonEmptyteamcoaches.length === 0) {
        ...
        formData.append(
          'previous_coaches',
          teamcoaches && JSON.stringify(teamcoaches),
        );
      }
      ...
      if (nonEmptyotherstaff.length === 0) {
        ...
        formData.append(
          'other_stuffs',
          otherstaff && JSON.stringify(otherstaff),
        );
      }
      ...
      if (nonEmptyalumniplayers.length === 0) {
        ...
        formData.append(
          'alumni_players',
          alumniplayers && JSON.stringify(alumniplayers),
        );
      }
      ...
      if (nonEmptyctivelyparticipate.length === 0) {
        ...
        formData.append(
          'active_competitions',
          activelyparticipate && JSON.stringify(activelyparticipate),
        );
      }
      ...
      if (response.data.err == false) {
        ...
        navigation.navigate('DashboardPage', {
          data: response.data.data.updated,
        });
      }
  ...
  const [activecompitition, setactivecompitition] = useState([
    {id: 1, name: ''},
  ]);
  ...
  const addClubs = () => {
    const newClubs = [
      ...clubs,
      {id: clubs.length + 1, name: '', from: '', to: ''},
    ];
    setClubs(newClubs);
  };
  ...
  const addcoaches = () => {
    const newcoaches = [
      ...coaches,
      {id: coaches.length + 1, name: '', from: '', to: ''},
    ];
  ...
  const addKeyPersonalities = () => {
    const newPersonalities = [
      ...keyPersonalities,
      {id: keyPersonalities.length + 1, name: '', designation: ''},
    ];
    setKeyPersonalities(newPersonalities);
  };

  const removeKeyPersonalities = index => {
    const updatedKeyPersonalities = keyPersonalities.filter(
      (_, i) => i !== index,
    );
  ...
  return (
    <View style={{flex: 1, backgroundColor: '#000'}}>
      ...
      <View style={{marginHorizontal: 10}}>
        <View style={{width: '100%', flexDirection: 'row', marginTop: 5}}>
          ...
          <View
            ...
            <View style={{}}>
              <Text style={{color: '#fff'}}>Upload Your Profile Picture</Text>
            </View>
            <TouchableOpacity
        ...
        <View
          ...
          <View style={{width: '25%', alignItems: 'center'}}>
            <Text
              style={{
                color: '#fff',
                fontSizeL: responsiveFontSize(2.5),
                fontWeight: '700',
              }}>
              User Type :
            </Text>
          ...
          <View style={{width: '75%'}}>
            <SelectDropdown
              ...
              onSelect={(selectedItem, index) => {
                const selectedItemObject = usertypeData.find(
          ...
          <View
            ...
            <View style={{width: '100%'}}>
              ...
              {errormsggname && errormsggname ? (
                <Text style={{color: '#f83228', fontSize: 12, paddingTop: 5}}>
                  {errormsggname && errormsggname}
                </Text>
              ) : (
                ''
            ...
            <View style={{width: '100%', paddingTop: 9}}>
              ...
              <SelectDropdown
                ...
                onSelect={(selectedItem, index) => {
                  const selectedGame =
                    gamedata &&
                    gamedata.find(item => item.name === selectedItem);
                  if (selectedGame) {
            ...
            <View style={{width: '100%', paddingTop: 9}}>
              ...
              <SelectDropdown
                ...
                onSelect={(selectedItem, index) => {
                  const selectedGame =
                    position &&
                    position.find(item => item.name === selectedItem);
                  if (selectedGame) {
                    const selectedGameId = selectedGame._id;
                    setpositionid(selectedGameId);
                    console.log(
                      'position issssssssssssss',
                      selectedItem,
                      selectedGameId,
                    );
                  }
            ...
            <View style={{width: '100%', paddingTop: 9}}>
              <View
                ...
                <TouchableOpacity onPress={addawards} style={{}}>
                  <AddPen
            ...
            <View style={{width: '100%', paddingTop: 9}}>
              <View
                ...
                <TouchableOpacity onPress={addmedals} style={{}}>
                  <AddPen
                    style={{color: '#fff', fontSize: responsiveFontSize(2)}}
                    name="pluscircle"
                  />
              ...
              clubs.map((club, index) => (
                <View key={club.id} style={{marginVertical: 10}}>
                  ...
                  <TextInput
                    ...
                    value={clubs.name}
                    onChangeText={text =>
                      handleClubsInputChange(text, 'name', index)
                    }
                  />
                  ...
                  <View style={{flexDirection: 'row', marginTop: 5}}>
                    <View style={{flex: 1, marginRight: 10}}>
                      ...
                      <TextInput
                        ...
                        value={clubs.from}
                        onChangeText={text =>
                          handleClubsInputChange(text, 'from', index)
                        }
                      />
                    </View>
                    <View style={{flex: 1}}>
                      ...
                      <TextInput
                        ...
                        value={clubs.to}
                        onChangeText={text =>
                          handleClubsInputChange(text, 'to', index)
                        }
                      />
                    </View>
                  </View>
              ...
              coaches.map((coaches, index) => (
                <View key={coaches.id} style={{marginVertical: 10}}>
                  ...
                  <TextInput
                    ...
                    value={coaches.name}
                    onChangeText={text =>
                      handlecoachesInputChange(text, 'name', index)
                    }
                  />
                  ...
                  <View style={{flexDirection: 'row', marginTop: 5}}>
                    <View style={{flex: 1, marginRight: 10}}>
                      ...
                      <TextInput
                        ...
                        value={coaches.from}
                        onChangeText={text =>
                          handlecoachesInputChange(text, 'from', index)
                        }
                      />
                    </View>
                    <View style={{flex: 1}}>
                      ...
                      <TextInput
                        ...
                        value={coaches.to}
                        onChangeText={text =>
                          handlecoachesInputChange(text, 'to', index)
                        }
                      />
                    </View>
                  </View>
      ...
      {saveusertype && saveusertype === 'other' && (
        <ScrollView
          style={{backgroundColor: 'grey', marginTop: 5, height: '100%'}}>
          <View
            style={{
              width: '100%',
              paddingHorizontal: 10,
            ...
            <View style={{width: '100%', paddingTop: 9}}>
              ...
              <SelectDropdown
                ...
                onSelect={(selectedItem, index) => {
                  const selectedGame =
                    personilitydropdown &&
                    personilitydropdown.find(
                      item => item.personality_type_name === selectedItem,
                    );
                  if (selectedGame) {
                    const selectedGameId = selectedGame._id;
            ...
            <View style={{width: '100%', paddingTop: 9}}>
              <View
                ...
                <TouchableOpacity onPress={addcertifications} style={{}}>
                  <AddPen
                    style={{color: '#fff', fontSize: responsiveFontSize(2)}}
                    name="pluscircle"
                  />
              ...
              {certifications.map((certificationsss, index) => (
                <View
                  ...
                  <TextInput
                    ...
                    onChangeText={text =>
                      handleInputChangecertifications(text, index)
                    }
                  />
                  {index > 0 && (
                    <TouchableOpacity
                      onPress={() => removecertifications(index)}>
                      <RemovePen
                        style={{
                          color: '#fff',
                          backgroundColor: '#000',
          ...
          <View
            ...
            <View style={{width: '100%', paddingTop: 9}}>
              <View
                ...
                <TouchableOpacity onPress={addteamplayers} style={{}}>
                  <AddPen
                    style={{color: '#fff', fontSize: responsiveFontSize(2)}}
                    name="pluscircle"
                  />
              ...
              {teamplayers.map((teamplayers, index) => (
                <View
                  ...
                  <TextInput
                    ...
                    onChangeText={text =>
                      handleInputChangeteamplayers(text, index)
                    }
                  />
                  {index > 0 && (
      ...
      {saveusertype && saveusertype == 'orgs' && (
        <ScrollView
          ...
          <View
                ...
                onSelect={(selectedItem, index) => {
                  const selectedGame =
                    ...
                    organizationtype.find(
                      item => item.org_type_name === selectedItem,
                    );
                  if (selectedGame) {
                    const selectedGameId = selectedGame._id;
            ...
            {keyPersonalities &&
              keyPersonalities.map((keyPersonalities, index) => (
                <View key={keyPersonalities.id} style={{marginVertical: 10}}>
                  ...
                  <TextInput
                    ...
                    onChangeText={text =>
                      handleKeyPersonalitiesInputChange(text, 'name', index)
                    }
                  />
