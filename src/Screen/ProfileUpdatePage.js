                ...
                reel && reel === "1" ?
                    ...
                    <View style={{ marginTop: 5, marginHorizontal: 10, }}>
                        ...
                        {profiledataget && profiledataget?.user_type === "player" && (
                            <ScrollView style={{ backgroundColor: "#424242", marginTop: 5, height: 500 }}>
                                <View style={{ width: "100%", paddingHorizontal: 10, paddingVertical: 10, height: '100%', }}>
                                    ...
                                    <View style={{ width: "100%", paddingTop: 9 }}>
                                        ...
                                        <SelectDropdown
                                            ...
                                            onSelect={(selectedItem, index) => {
                                                const selectedGame = gamedata.find(item => item.name === selectedItem);
                                                if (selectedGame) {
                                            ...
                                            {profiledataget.clubs.map((item, index) => (
                                                <View key={index}>
                                                    ...
                                                    <TextInput
                                                        ...
                                                        onChangeText={(text) => handleclubsNameChange(index, 'name', text)}
                                                        style={{ backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                    />
                                                    ...
                                                    <View style={{ width: "100%", flexDirection: "row", gap: 3, alignItems: "center" }}>
                                                        <TextInput
                                                            ...
                                                            onChangeText={(text) => handleclubsNameChange(index, 'from', text)}
                                                            style={{ width: "50%", backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                        />

                                                        <TextInput
                                                            value={Clubs[index]?.to}
                                                            onChangeText={(text) => handleclubsNameChange(index, 'to', text)}
                                                            style={{ width: "50%", backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                        />
                                            ...
                                            {profiledataget.coaches.map((item, index) => (
                                                <View key={index}>
                                                    ...
                                                    <TextInput
                                                        ...
                                                        onChangeText={(text) => handleCoachesNameChange(index, 'name', text)}
                                                        style={{ backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                    />
                                                    ...
                                                    <View style={{ width: "100%", flexDirection: "row", gap: 3, alignItems: "center" }}>
                                                        <TextInput
                                                            ...
                                                            onChangeText={(text) => handleCoachesNameChange(index, 'from', text)}
                                                            style={{ width: "50%", backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                        />

                                                        <TextInput
                                                            value={coaches[index]?.to}
                                                            onChangeText={(text) => handleCoachesNameChange(index, 'to', text)}
                                                            style={{ width: "50%", backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                        />
                                    ...
                                    <View style={{}}>
                                        <TouchableOpacity style={{
                                            ...
                                            <Text style={{ color: '#fff', fontSize: 14 }}>Edit Profile Details</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            </ScrollView>
                                ...
                                <View style={{ width: "100%", paddingHorizontal: 10, paddingVertical: 10, height: '100%', }}>
                                    ...
                                    <View style={{ width: "100%", paddingTop: 9 }}>
                                        ...
                                        <SelectDropdown
                                            ...
                                            data={personilitydropdown.map((item) => item.personality_type_name)}
                                            defaultButtonText={profiledataget?.type_name}
                                            onSelect={(selectedItem, index) => {
                                                const selectedGame = personilitydropdown.find(item => item.name === selectedItem);
                                                if (selectedGame) {
                                                    const selectedGameId = selectedGame._id;
                                                    setposition(selectedGameId);
                                                    getpostion(selectedGameId)
                                        ...
                                        <View style={{ width: '100%', marginTop: 5 }}>
                                            ...
                                            {certifications.map((item, index) => (
                                                <TextInput
                                                    style={{ backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                    value={item.name}
                                                    onChangeText={(text) => handleCertificationsNameChange(index, text)}
                                                />
                                            ))}
                                        </View>
                                    ) : null}
                            ...
                            <ScrollView style={{ backgroundColor: "grey", marginTop: 5, height: 500 }}>
                                <View style={{ width: "100%", paddingHorizontal: 10, paddingVertical: 10, height: '100%', }}>
                                                    ...
                                                    profiledataget && profiledataget?.dob ?
                                                        <>
                                                            <View style={{ marginTop: 5, }}>
                                                                {
                                                                    startdate && startdate ?
                                                                        <View style={{ backgroundColor: "#fff", paddingVertical: 10, paddingLeft: 5, borderRadius: 5 }}>
                                                                            <Text style={{ color: '#000', fontSize: responsiveFontSize(1.9) }}>{startdate && startdate}</Text>
                                                                        </View>
                                                                        :
                                                                        <View style={{ backgroundColor: "#fff", paddingVertical: 10, paddingLeft: 5, borderRadius: 5 }}>
                                                            ...
                                                            <View style={{ marginTop: 10 }}>
                                                                <Text style={{ color: '#fff', fontSize: responsiveFontSize(1.9), textDecorationLine: 'underline' }} onPress={() => setOpen(true)}>Select new date</Text>
                                                            </View>
                                                        </>
                                                        : ""
                                        ...
                                        <View style={{ width: '100%', marginTop: 5 }}>
                                            ...
                                            {managements.map((item, index) => (
                                                <TextInput
                                                    style={{ backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                    value={item.name}
                                                    onChangeText={(text) => handleManagementNameChange(index, text)}
                                                />
                                            ))}
                                        </View>
                                    ) : null}
                                    ...
                                    {teamcoaches.length > 0 ? (
                                        <View style={{ width: '100%', marginTop: 5 }}>
                                            <View>
                                                <Text style={{ color: '#000', fontSize: 16 }}> Previous_Coaches</Text>
                                            </View>
                                            ...
                                            {teamcoaches.map((item, index) => (
                                                <TextInput
                                                    style={{ backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                    value={item.name}
                                                    onChangeText={(text) => handleprevious_coachesNameChange(index, text)}
                                                />
                                            ))}
                                        </View>
                                    ) : null}
                                        ...
                                        <View style={{ width: '100%', marginTop: 5 }}>
                                            ...
                                            {otherstaff.map((item, index) => (
                                                <TextInput
                                                    style={{ backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                    value={item.name}
                                                    onChangeText={(text) => handleotherstaffNameChange(index, text)}
                                                />
                                            ))}
                                        </View>
                                    ) : null}
                                        ...
                                        <View style={{ width: '100%', marginTop: 5 }}>
                                            ...
                                            {teamplayers.map((item, index) => (
                                                <TextInput
                                                    style={{ backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                    value={item.name}
                                                    onChangeText={(text) => handleteamplayersNameChange(index, text)}
                                                />
                                            ))}
                                        </View>
                                    ) : null}
                                    ...
                                    {alumniplayers.length > 0 ? (
                                        <View style={{ width: '100%', marginTop: 5 }}>
                                            <View>
                                                <Text style={{ color: '#000', fontSize: 16 }}> Alumni Players names</Text>
                                            </View>
                                            ...
                                            {alumniplayers.map((item, index) => (
                                                <TextInput
                                                    style={{ backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                    value={item.name}
                                                    onChangeText={(text) => handlealumniplayersNameChange(index, text)}
                                                />
                                            ))}
                                        </View>
                                    ) : null}
                                        ...
                                        <View style={{ width: '100%', marginTop: 5 }}>
                                            ...
                                            {activelyparticipate.map((item, index) => (
                                                <TextInput
                                                    style={{ backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
                                                    value={item.name}
                                                    onChangeText={(text) => handleactivelyparticipateChange(index, text)}
                                                />
                                            ))}
                                        </View>
                                    ) : null}
                                ...
                                <View style={{ width: "100%", paddingHorizontal: 10, paddingVertical: 10, height: '100%', }}>
                                    ...
                                    <View style={{ width: "100%", paddingTop: 9 }}>
                                        ...
                                        <SelectDropdown
                                            ...
                                            defaultButtonText={profiledataget && profiledataget?.org_type_name}
                                            onSelect={(selectedItem, index) => {
                                                const selectedGame = organizationtype.find(item => item.name === selectedItem);
                                                if (selectedGame) {
                                                    const selectedGameId = selectedGame._id;
                                    ...
                                    {/* key Personalities*/}
                                    {
                                        profiledataget && profiledataget?.key_personalities.length > 0 ?
                                            <View style={{ width: "100%", marginTop: 5 }}>
                                                ...
                                                {
                                                    profiledataget && profiledataget.key_personalities?.map((item, index) => {
                                                        return (
                                                            <View key={index}>
                                                                <TextInput
                                                                    style={{ backgroundColor: "#fff", paddingVertical: 5, paddingLeft: 5, marginTop: 5, borderRadius: 5, color: "#000" }}
