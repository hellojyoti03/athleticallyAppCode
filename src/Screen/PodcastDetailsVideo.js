...
//     // const initialIndex = data.findIndex((item) => console.log("polllllll",item));
//     if (initialIndex !== -1) {
          ...
          return (
            <View style={{ flex: 1 }}>
              ...
              <TouchableOpacity style={styles.backButton}>
                <Back name="leftcircleo" style={styles.icon} />
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  video: {
    flex: 1,
    backgroundColor: '#000', // Set background color for video
  },
  backButton: {
    position: 'absolute',
    top: 10,
