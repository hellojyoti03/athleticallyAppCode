...
const Events = () => {
  ...
  const getevent = async date => {
    ...
    try {
      ...
      if (selectedDate && selectedDate) {
        const response = await axios.post(`/api/v1/get-events`, {
  ...
  const postevent = async () => {
    try {
      ...
      const response = await axios.post(`/api/v1/add-event`, {
        user_id: modifiedUser.user_id,
  ...
  const posteditevent = async data => {
    ...
    try {
      ...
      const response = await axios.post(`/api/v1/edit-event`, {
  ...
  const deleteeventcard = async item => {
    try {
      ...
      const response = await axios.post(`/api/v1/delete-event`, {
        user_id: item.userid,
    ...
    <View style={{flex: 1, backgroundColor: '#000'}}>
      ...
      <DatePicker
        ...
        onConfirm={date => {
          ...
          console.log('Formatt   ededit Date:', formattededitedDate);
        }}
        onCancel={() => {
          seteditOpen(false);
        }}
          ...
          <LinearGradient
            ...
            <TouchableOpacity onPress={() => handleDateSelection(nextDate1)}>
              <Text
                ...
                {formatDateDay(nextDate1)}
              </Text>
              <Text style={{color: '#fff', fontSize: responsiveFontSize(2)}}>
                {formatDateMonth(nextDate1)}
              </Text>
            </TouchableOpacity>
          </LinearGradient>
          ...
          <LinearGradient
            ...
            <TouchableOpacity onPress={() => handleDateSelection(nextDate2)}>
              <Text
                ...
                {formatDateDay(nextDate2)}
              </Text>
              <Text style={{color: '#fff', fontSize: responsiveFontSize(2)}}>
                {formatDateMonth(nextDate2)}
              </Text>
            </TouchableOpacity>
          </LinearGradient>
        </View>
      ...
      {(storeusertype && storeusertype == 'team') ||
      (storeusertype && storeusertype == 'orgs') ? (
      ...
      {load && load == true ? (
        ...
        <FlatList
          data={
            geteventdetails && geteventdetails.length > 0 ? geteventdetails : ''
          }
              ...
              <View style={{}}>
                <View style={{width: '100%', margin: 10, flexDirection: 'row'}}>
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() =>
                        openeditmodel({userid: item.user_id, eventid: item._id})
                      }
                      style={{marginTop: 9}}>
                      <Edit
                        name="edit"
        ...
        <View
          ...
          <ScrollView>
            ...
            <View style={{marginHorizontal: 8}}>
              <Text style={{color: '#000', fontSize: 16}}>Event Title</Text>
              <TextInput
            ...
            {/* Enter event for */}
            <View style={{marginHorizontal: 8, marginTop: 10}}>
              <Text style={{color: '#000', fontSize: 16}}>Event For</Text>
              <TextInput
            ...
            {/* Enter coached_by */}
            <View style={{marginHorizontal: 8, marginTop: 10}}>
              <Text style={{color: '#000', fontSize: 16}}>Coached By</Text>
              <TextInput
            ...
            {/* Enter scouted_by */}
            <View style={{marginHorizontal: 8, marginTop: 10}}>
              <Text style={{color: '#000', fontSize: 16}}>Scouted By</Text>
              <TextInput
            ...
            {/* Enter map_link */}
            <View style={{marginHorizontal: 8, marginTop: 10}}>
              <Text style={{color: '#000', fontSize: 16}}>Map Link</Text>
              <TextInput
            ...
            <View style={{marginHorizontal: 8, marginTop: 10}}>
              <Text style={{color: '#000', fontSize: 16}}>Event Date</Text>
            </View>
            ...
            {/* Enter event_datetime */}
            <View style={{marginHorizontal: 8, marginTop: 10}}>
              <Text style={{color: '#000', fontSize: 16}}>Event Time</Text>
            </View>
      ...
      >
        <View
          ...
          <View style={{marginTop: 10, paddingHorizontal: 10, width: '100%'}}>
            <Text style={{color: '#000', fontSize: 16}}>Event Description</Text>
            <TextInput
              placeholder="Enter Event Description"
              placeholderTextColor={'#6F7074'}
              onChangeText={value => seteventdescrp(value)}
              ...
              <View
                ...
                {editstartdate && editstartdate ? (
                  <Text
                    ...
                    {editstartdate &&
                      editstartdate.toString().replaceAll('/', '-')}
                  </Text>
                ) : (
                  <Text
                    style={{
