                    ...
                    :
                        ...
                        <ScrollView style={{ flex: 1, backgroundColor: "grey", marginTop: 2 }}>
                            ...
                            <View style={{ width: "100%", paddingHorizontal: 10 }}>
                                ...
                                {coaches && coaches.map((club, index) => (
                                    <View key={club.id} style={{ marginVertical: 10 }}>
                                        <Text style={{ color: '#fff', fontSize: responsiveFontSize(1.8), marginBottom: 5 }}>
                                            Coaches #{index + 1}
                                        </Text>
                                        ...
                                        <View style={{ flexDirection: 'row', marginTop: 5 }}>
                                            <View style={{ flex: 1, marginRight: 10 }}>
                                                ...
                                                <TextInput
                                                    ...
                                                    onChangeText={(text) => handlecoachesInputChange(text, 'joinDate', index)}
                                                />
                                            </View>
                                            <View style={{ flex: 1 }}>
                                                <Text style={{ color: '#fff', fontSize: responsiveFontSize(1.8), marginBottom: 5 }}>
                                                ...
                                                <TextInput
                                                    ...
                                                    onChangeText={(text) => handlecoachesInputChange(text, 'exitDate', index)}
                                                />
                                            </View>
                                        </View>
