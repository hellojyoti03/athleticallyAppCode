                  ...
                  <View style={{flexDirection: 'row', marginTop: 5}}>
                    <View style={{flex: 1, marginRight: 10}}>
                      ...
                      <TextInput
                        ...
                        value={club.joinDate}
                        onChangeText={text =>
                          handleClubsInputChange(text, 'joinDate', index)
                        }
                      />
                    </View>
                    <View style={{flex: 1}}>
                      ...
                      <TextInput
                        ...
                        value={club.exitDate}
                        onChangeText={text =>
                          handleClubsInputChange(text, 'exitDate', index)
                        }
                      />
                    </View>
                  </View>
                  ...
                  <View style={{flexDirection: 'row', marginTop: 5}}>
                    <View style={{flex: 1, marginRight: 10}}>
                      ...
                      <TextInput
                        ...
                        value={coaches.joinDate}
                        onChangeText={text =>
                          handlecoachesInputChange(text, 'joinDate', index)
                        }
                      />
                    </View>
                    <View style={{flex: 1}}>
                      ...
                      <TextInput
                        ...
                        value={coaches.exitDate}
                        onChangeText={text =>
                          handlecoachesInputChange(text, 'exitDate', index)
                        }
                      />
                    </View>
                  </View>
